...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def __init__(self, config: InstructBlipConfig):
        ...
        self.max_sequence_length = config.text_config.max_sequence_length if hasattr(config.text_config, "max_sequence_length") else 1024
        # Initialize weights and apply final processing
        self.post_init()
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        outputs = self.language_model.generate(
            inputs_embeds=inputs_embeds.to('cuda:4'),
            attention_mask=attention_mask,
            **generate_kwargs,
        )
