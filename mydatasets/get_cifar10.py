...
def get_cifar10(args, processor, return_classnames=False):
    image_text_dataset = image_text_CIFAR(args.data_location, train=True, transform=processor)
    ...
    return_list = []
    if args.exemplar:
        exemplar_dataset = image_text_CIFAR(args.data_location, train=True, transform=processor, exemplar=True, num_exemplar=args.num_exemplar)
